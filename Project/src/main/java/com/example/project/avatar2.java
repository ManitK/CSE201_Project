...
public class avatar2 implements avatar{

    private static ImageView stickmanImageView;
    public avatar2(ImageView stickmanImageView) {
    ...
    public void setImage2() {
        ...
        Image initialImage = new Image("/Images/avatar2.png");
    ...
    public void changeCharacter(int x) {
        ...
        else if(x==3){stickmanImageView.setImage(new Image("/Images/avatar3.png"));}
    }
